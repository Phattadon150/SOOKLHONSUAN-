...
// (รวมร่าง authController_Google.js และแก้ Key JWT ให้ตรงกัน)
...
// --- ฟังก์ชัน Register (จากไฟล์ Google) ---
...
// --- ฟังก์ชัน Login (จากไฟล์ Google และ ⭐️ แก้ไข Key) ---
const login = async (req, res) => {
  ...
  try {
    ...
    // ⭐️ แก้ไข: เปลี่ยนจาก { userId: user.id } เป็น { id: user.id }
...
// --- ฟังก์ชัน getMe (จากไฟล์ Google และ ⭐️ แก้ไข Key) ---
const getMe = async (req, res) => {
  try {
    // ⭐️ แก้ไข: เปลี่ยนจาก req.user.userId เป็น req.user.id
...
// --- ฟังก์ชัน checkUsername (จากไฟล์ Google) ---
...
// --- ฟังก์ชัน googleLogin (จากไฟล์ Google และ ⭐️ แก้ไข Key) ---
...
// --- ฟังก์ชัน googleCompleteSignup (จากไฟล์ Google และ ⭐️ แก้ไข Key) ---
